...
import com.zq.zqbagu.mapper.QuestionBankMapper;
import com.zq.zqbagu.model.dto.questionBank.QuestionBankQueryRequest;
import com.zq.zqbagu.model.entity.QuestionBank;
import com.zq.zqbagu.model.entity.User;
import com.zq.zqbagu.model.vo.QuestionBankVO;
import com.zq.zqbagu.model.vo.UserVO;
import com.zq.zqbagu.service.QuestionBankService;
...
public class QuestionBankServiceImpl extends ServiceImpl<QuestionBankMapper, QuestionBank> implements QuestionBankService {
    ...
    public QueryWrapper<QuestionBank> getQueryWrapper(QuestionBankQueryRequest questionBankQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            // 需要拼接查询条件
            queryWrapper.and(qw -> qw.like("title", searchText).or().like("description", description));
        }
        // 模糊查询
